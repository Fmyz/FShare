...
@implementation FShareOAuthParam
...
{
    FShareSinaOAuthParam *param = [[FShareSinaOAuthParam alloc] init];
...
@implementation FShareTencentOAuthParam

+ (instancetype)defaultParam
{
    FShareTencentOAuthParam *param = [[FShareTencentOAuthParam alloc] init];
...
@implementation FShareWeiXinOAuthParam

+ (instancetype)defaultParam
{
    FShareWeiXinOAuthParam *param = [[FShareWeiXinOAuthParam alloc] init];
...
@implementation FShareRequestParam
@end
